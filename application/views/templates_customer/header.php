      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('customer/data_mobil'); ?>">Beranda
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('customer/about') ?>">Tentang CAR-GO</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('customer/contact') ?>">Contact</a>
            </li>
            ...
            <?php if ($this->session->userdata('nama')) { ?>
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('auth/logout'); ?>">Hai <?= $this->session->userdata('nama'); ?><span> | KELUAR</span></a>
              </li>
            <?php } else { ?>
              <li class="nav-item">
